...
public class JSortMain {
	public static void main(String[] args) {
		int[] m = { 67, 700, 735, 287, 830, 360, 753, 332, 899, 616, 990, 890, 933, 975, 275, 707, 271, 80, 409, 602,
				...
				938, 600, 190, 81, 544, 406, 692, 765, 179, 32, 629, 437, 804, 911, 42, 836, 770 }; // 100개인 배열을 선언하고
																									// 초기화한다.
